    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2 font-sarabun">ยังไม่ได้ตั้งค่าแบรนด์</h2>
          <p className="text-gray-500 font-sarabun mb-4">กรุณากรอกข้อมูลแบรนด์ก่อนเริ่มใช้งาน</p>
